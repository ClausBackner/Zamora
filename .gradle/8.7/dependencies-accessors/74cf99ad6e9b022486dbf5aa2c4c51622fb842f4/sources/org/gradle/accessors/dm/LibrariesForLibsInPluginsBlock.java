...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final ChartingLibraryAccessors laccForChartingLibraryAccessors = new ChartingLibraryAccessors(owner);
    ...
    private final QuanqlLibraryAccessors laccForQuanqlLibraryAccessors = new QuanqlLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>clickablepiechart</b> with <b>com.github.furkanaskin:ClickablePieChart</b> coordinates and
     * with version reference <b>clickablepiechart</b>
     * <p>
     ...
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getClickablepiechart() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("clickablepiechart");
    }
    ...
    /**
     * Group of libraries at <b>charting</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public ChartingLibraryAccessors getCharting() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForChartingLibraryAccessors;
    }
    ...
    /**
     * Group of libraries at <b>quanql</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public QuanqlLibraryAccessors getQuanql() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForQuanqlLibraryAccessors;
    }
    ...
    public static class AndroidLibraryAccessors extends SubDependencyFactory {
        private final AndroidHoloLibraryAccessors laccForAndroidHoloLibraryAccessors = new AndroidHoloLibraryAccessors(owner);

        public AndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>android.holo</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AndroidHoloLibraryAccessors getHolo() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAndroidHoloLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class AndroidHoloLibraryAccessors extends SubDependencyFactory {

        public AndroidHoloLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>graph</b> with <b>org.quanqi:android-holo-graph</b> coordinates and
         * with version reference <b>androidHoloGraph</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getGraph() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("android.holo.graph");
        }
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
        ...
        private final AndroidxSliceLibraryAccessors laccForAndroidxSliceLibraryAccessors = new AndroidxSliceLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>androidx.slice</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AndroidxSliceLibraryAccessors getSlice() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAndroidxSliceLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class AndroidxSliceLibraryAccessors extends SubDependencyFactory {

        public AndroidxSliceLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>core</b> with <b>androidx.slice:slice-core</b> coordinates and
         * with version reference <b>sliceCore</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getCore() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.slice.core");
        }
     ...
     */
    @Deprecated
    public static class ChartingLibraryAccessors extends SubDependencyFactory {

        public ChartingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>mpandroidchart</b> with <b>com.github.mikephil.charting:mpandroidchart</b> coordinates and
         * with version reference <b>mpandroidchartVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getMpandroidchart() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("charting.mpandroidchart");
        }
     ...
     */
    @Deprecated
    public static class QuanqlLibraryAccessors extends SubDependencyFactory {
        private final QuanqlAndroidLibraryAccessors laccForQuanqlAndroidLibraryAccessors = new QuanqlAndroidLibraryAccessors(owner);

        public QuanqlLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>quanql.android</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public QuanqlAndroidLibraryAccessors getAndroid() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForQuanqlAndroidLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class QuanqlAndroidLibraryAccessors extends SubDependencyFactory {
        private final QuanqlAndroidHoloLibraryAccessors laccForQuanqlAndroidHoloLibraryAccessors = new QuanqlAndroidHoloLibraryAccessors(owner);

        public QuanqlAndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>quanql.android.holo</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public QuanqlAndroidHoloLibraryAccessors getHolo() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForQuanqlAndroidHoloLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class QuanqlAndroidHoloLibraryAccessors extends SubDependencyFactory {

        public QuanqlAndroidHoloLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>graph</b> with <b>org.quanql:android-holo-graph</b> coordinates and
         * with version reference <b>androidHoloGraphVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getGraph() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("quanql.android.holo.graph");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidHoloGraph</b> with value <b>0.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroidHoloGraph() { return getVersion("androidHoloGraph"); }

        /**
         * Version alias <b>androidHoloGraphVersion</b> with value <b>0.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroidHoloGraphVersion() { return getVersion("androidHoloGraphVersion"); }
        ...
        /**
         * Version alias <b>clickablepiechart</b> with value <b>1.0.9</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getClickablepiechart() { return getVersion("clickablepiechart"); }
        ...
        /**
         * Version alias <b>mpandroidchartVersion</b> with value <b>v3.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMpandroidchartVersion() { return getVersion("mpandroidchartVersion"); }
        ...
        /**
         * Version alias <b>runtime</b> with value <b>1.7.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>sliceCore</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSliceCore() { return getVersion("sliceCore"); }
